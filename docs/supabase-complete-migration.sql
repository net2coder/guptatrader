-- ============================================================
-- GUPTA TRADERS - COMPLETE SUPABASE MIGRATION SCRIPT
-- ============================================================
-- Run this entire script in your Supabase SQL Editor
-- Make sure to replace 'your-admin@email.com' with your actual admin email
-- ============================================================
...
-- CHECK STOCK BEFORE ORDER ITEM FUNCTION
...
-- ==========================================
-- STEP 9: INSERT DEFAULT STORE SETTINGS
-- ==========================================
INSERT INTO store_settings (key, value, type) VALUES
  ('store_name', 'Gupta Traders', 'text'),
  ('store_email', 'contact@guptatraders.com', 'text'),
  ('store_phone', '+91 1234567890', 'text'),
  ('store_address', 'Your Store Address', 'text'),
...
-- Run this command separately after creating the database:
...
-- ============================================================
-- Next steps:
-- 1. Set admin email: ALTER DATABASE postgres SET app.settings.admin_email = 'your-email@example.com';
-- 2. Enable auto-confirm for email signups in Authentication settings
-- 3. Update your .env file with the new Supabase credentials
-- 4. Import your existing data (categories, products, etc.)
-- ============================================================
